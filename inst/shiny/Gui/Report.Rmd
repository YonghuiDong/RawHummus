...
if (nrow(autoTarget) > 0) {
 autoTargetTable <- autoTarget %>%
  ...
  mutate("Max RT Diff (min)" = kableExtra::cell_spec(`Max RT Diff (min)`,
                                                     background = ifelse(`Max RT Diff (min)` > 1, "#FFA500", "#FFFFFF")),
         "Max Mass Diff (ppm)" = kableExtra::cell_spec(`Max Mass Diff (ppm)`, 
                                                       background = ifelse(`Max Mass Diff (ppm)` > 5, "#FFA500", "#FFFFFF")),
         "Max Intensity Ratio" = kableExtra::cell_spec(`Max Intensity Ratio`, 
                                                       background = ifelse(`Max Intensity Ratio` > 3, "#FFA500", "#FFFFFF")))
 
 ## DT::datatable(autoTargetTable) 
 ## use kableExtra instead of DT
 kableExtra::kbl(autoTargetTable, escape = FALSE, caption = "Table: Summary of auto-selected peaks") %>%
...
## use kableExtra instead of DT 
 kableExtra::kbl(myTargetTable, escape = FALSE, caption = "Table: Summary of user-defined peaks") %>%
  kableExtra::kable_paper("hover", full_width = TRUE)
...
## use kableExtra instead of DT 
if(!is.null(getMS2)){
  kableExtra::kbl(getMS2, escape = FALSE, caption = "Table: Summary of MS2 events") %>%
