...
It is worth noting that the above statistics are rough estimations from the raw data files, it may not accurately reflect the true values after fine data processing.
